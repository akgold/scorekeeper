...
/***/ function(module, exports, __webpack_require__) {
	...
	function draw(err, data) {
	  if (err) {
	    ...
	    (function () {
	      var fontScale = d3.scaleLinear().range([1, 3]).domain(d3.extent(_underscore2.default.pluck(data, 'score')));
	      var fontMap = function fontMap(d) {
	        return fontScale(d.score) + 'em';
	      };
	...
	function randomize(data) {
	  return _underscore2.default.map(data, function (d) {
